...
const BarChart1 = () => {
    ...
    const {email, users, isLoading, setIsLoading} = useSatoshi();
    ...
    useEffect(()=>{
        ...
        let bnUs = [];
            ...
            const getData= async()=>{
                const reqData= await fetch("https://tranquil-beyond-13898.herokuapp.com/table5");
                const resData= await reqData.json();
                
                resData.map(i=>{
                    if( i?.theid === 1){
                        i.monthlycoins.map(c=> bn.push({
                            coinName: c?.s,
                            coinPrice: c?.P,
                            coinValue: c?.V
                        ...
                        i.monthlycoins.map(c=> bnUs.push({
                            coinName: c?.s,
                            coinPrice: c?.P,
                            coinValue: c?.V 
    ...
    },[bnCoins, bnUsCoins, data,email,users, setIsLoading])
